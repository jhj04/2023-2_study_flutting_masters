...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void initState() {
    ...
    super.initState();
    webtoon = ApiService.getToonById(widget.id); // widget.id에 접근
    episodes = ApiService.getLatestEpisodesById(widget.id); // 접근, 초기화
    initPrefs();
  }
              ...
              children: [
                Hero(
                  ...
                  child: Container(
                                ...
                                child: Image.network(widget.thumb),  //widget.thumb(stateful widget)
                              ),
                ),
              ],
            ),
